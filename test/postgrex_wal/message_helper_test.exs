defmodule PostgrexWal.MessageHelperTest do
  use ExUnit.Case, async: true
  alias PostgrexWal.MessageHelper

  test "decode_lsn/1 behaves as expected" do
    assert "0/2E3FBE8" == "0/2E3FBE8" |> encode_lsn() |> MessageHelper.decode_lsn()
    assert 48_495_592 == 48_495_592 |> MessageHelper.decode_lsn() |> encode_lsn()
    assert 48_495_592 == encode_lsn("0/2E3FBE8")
    assert "0/2E3FBE8" == MessageHelper.decode_lsn(48_495_592)
  end
